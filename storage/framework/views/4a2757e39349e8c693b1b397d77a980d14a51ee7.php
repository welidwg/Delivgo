                                    ...
                                    <div class="modal-body p-4 px-5 ">
                                        ...
                                        <script>
                                            ...
                                            $("#editToppForm<?php echo e($topping->id); ?>").on("submit", (e) => {
                                                ...
                                                let formEditTopp<?php echo e($topping->id); ?> = new FormData(formEditTopp<?php echo e($topping->id); ?>)

                                                axios.post("/toppings/update/<?php echo e($topping->id); ?>", formEditTopp<?php echo e($topping->id); ?>)
                                                    .then(res => {
                                                        toastr.info(res.data.message)
                                                        $(".modal").modal("hide")
                                                        setTimeout(() => {
