                ...
                <div class="modal-body p-4 px-5 ">
                    <div class="main-content mb-3 py-auto">
                        ...
                        <form action="#" id="AddCategoryForm" class="formsModal">
                            ...
                            <input type="hidden" name="resto_id" value="<?php echo e(Auth::user()->user_id); ?>">
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\Delivgo\resources\views/dash/modals/menuModals.blade.php ENDPATH**/ ?>