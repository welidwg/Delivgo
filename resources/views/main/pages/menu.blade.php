            ...
            animate__animated animate__fadeInUp">
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6 info mx-auto">
                        ...
                        <h4>Localisation:</h4>
                        <p>{{ $resto->address }}<br>{{ $resto->city }}, Tunisie</p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row menu-container">
                    ...
                    @forelse ($resto->products as $product)
                        <div class="col-lg-6  menu-item " id="products{{ $product->product_id }}">
                            <script>
                                let cls = "{{ $product->category->label }}".replace(/\s+/g, '')
                                console.log("{{ $product->category->label }}".replace(/\s+/g, ''));
                                $("#products{{ $product->product_id }}").addClass(cls)
                            </script>
