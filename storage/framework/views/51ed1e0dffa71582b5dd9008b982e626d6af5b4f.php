                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-3 col-md-6 mt-4 mt-lg-0 info mx-auto">
                                ...
                                <p>
                                    ...
                                    <?php if($now->between($start, $end, true)): ?>
                                        <?php echo e($check->frais_nuit); ?> TND


                                        <small class="color-1">*frais de nuits </small>
                                    <?php else: ?>
                                        <?php if(Auth::check() && Auth::user()->city != null): ?>
                                            <span class="fw-bold"><?php echo e(Auth::user()->region->deliveryPrice); ?> TND</span>
                                        <?php else: ?>
                                ...
                                <div class="col-lg-12 d-flex justify-content-center">
                                    <ul id="menu-flters">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <li data-filter=".<?php echo e(str_replace(' ', '', $cat->label)); ?>">
                                                <?php echo e($cat->label); ?></li>
                        ...
                        <div class="row menu-container">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $resto->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="col-lg-6  menu-item <?php echo e(str_replace(' ', '', $product->category->label)); ?> "
                                    ...
                                    <div class="d-flex align-items-center h-auto shadow p-3 m-2"
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2 flex-wrap">
                                                ...
                                                <span class="fw-light fs-5 color-1"> <i class="fal fa-coins"></i>
                                                    <?php echo e($product->price); ?> TND</span>
                                                ...
                                                <?php if(Auth::check()): ?>
                                                    <?php if($resto->onDuty): ?>
                                                        <?php if(Auth::user()->type == 2): ?>
                                                            <button type="button" id="notauth<?php echo e($product->product_id); ?>"
                                                                class="btn color-dark fs-4 align-self-end"
                                                                style="border-radius: 12px"><i
                                                                    class="fal fa-cart-plus"></i></button>
                                                            <script>
                                                                $("#notauth<?php echo e($product->product_id); ?>").on("click", (e) => {
                                                                    toastr.error("Impossible de passez une commande en tant qu'un restaurant")
                                                                })
                                                            </script>
                                                        <?php else: ?>
                                                    ...
                                                    <?php else: ?>
                                                        <button type="button"
                                                            id="notAvailable<?php echo e($product->product_id); ?>"
                                                            class="btn color-dark fs-4 align-self-end"
                                                            style="border-radius: 12px"><i
                                                                class="fal fa-cart-plus"></i></button>
                                                        <script>
                                        ...
                                        <div class="modal-content rounded-0">
                                            <div class="modal-body p-4 px-5 ">
                                                ...
                                                <div class="main-content text-center mb-3 py-auto">
                                                    ...
                                                    <h6 for="" class="mb-3 fs-3 color-3">
                                                        <?php echo e($product->label); ?><br>
                                                        <small class="text-muted"
                                                            style="font-size: 17px"><?php echo e($product->price); ?>
                                                    ...
                                                    <form action="#" class="formsModal"
                                                        ...
                                                        <input type="hidden" value="<?php echo e($product->product_id); ?>"
                                                            name="product_id">
                                                        <input type="hidden" value="<?php echo e($resto->user_id); ?>"
                                                            name="resto_id">
                                                        <div class="border rounded p-3">
                                                            <div
                                                                ...
                                                                <div
                                                                    class="d-flex flex-column align-items-center px-3 py-auto">
                                                                    <a class=" fw-bold"
                                                                        id="incr<?php echo e($product->product_id); ?>">
                                                                        <i class="fas fa-plus"></i>

                                                                    </a>
                                                                    <a class=" fw-bold"
                                                                        id="decr<?php echo e($product->product_id); ?>">
                                                        ...
                                                        <?php if($product->have_toppings): ?>
                                                            <div class="border rounded p-3 mt-2">
                                                                <h6 class="text-center color-1 fw-bold"> <i
                                                                        class="fal fa-sandwich"></i> Choisissez vos
                                                                    garnitures :
                                                        ...
                                                        <?php if($product->have_supplement): ?>
                                                            <div class="border rounded p-3 mt-2">
                                                                <h6 class="text-center color-1 fw-bold"> <i
                                                                        class="fal fa-utensils-alt"></i> Choisissez vos
                                                                    suppléments
                                                                    <br> <small class="text-success">Maximum :
                                                        ...
                                                        <?php if($product->have_drinks): ?>
                                                            <div class="border rounded p-3 mt-2">
                                                                <h6 class="text-center color-1 fw-bold"> <i
                                                                        class="fal fa-cocktail"></i> Choisissez vos
                                                                    boissons :<br>
