 ...
 <div class="card ">
     <div class="card-body ">
         ...
         <div class="table-responsive  p-1 text-nowrap " style="border-radius: 12px;">
                                         ...
                                         <div class="main-content text-center mb-3 py-auto">
                                             ...
                                             <div class="row flex-column justify-content-start align-items-center">
                                                 ...
                                                 <div class="col mb-2">
                                                     <span>Total : <strong>
                                                             <?php if($cmd->by_night): ?>
                                                                 <?php echo e(${'total' . $cmd->id} + $frais_nuit->frais_nuit); ?>

                                                                 TND
                                                             <?php else: ?>
                                                                 <?php if($cmd->is_message): ?>
                                                                     Livraison :
                                                                     <?php echo e(Auth::user()->region->deliveryPrice); ?> Dt
                                                                 <?php else: ?>
                                                     ...
                                                     <div class="col mb-2">
                                                         <span>Livreur : <strong>
                                                                 <?php if($cmd->taken): ?>
                                                                     ...
                                                                     Téléphone:
                                                                     <strong><?php echo e($cmd->deliverer->phone); ?></strong>
                                                                 <?php else: ?>
                                                                     <span class="text-warning">
                                                                         en attente de livreur
