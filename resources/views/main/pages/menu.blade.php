                                ...
                                <div class="col-lg-12 d-flex justify-content-center">
                                    <ul id="menu-flters">
                                        ...
                                        @forelse ($categories as $cat)
                                            <li data-filter=".{{ str_replace(' ', '', $cat->label) }}">
                                                {{ $cat->label }}</li>
                                        @empty
                                        ...
                                        Piment jalapeño, pepperoni, Bo.... <a href="" class="fw-bold">More</a> --}}
                                            ...
                                            <div class="col-lg-12 " style="text-align: right">
                                                ...
                                                @if (Auth::check())
                                                    ...
                                                    @else
                                                        <button type="button"
                                                            id="notAvailable{{ $product->product_id }}"
                                                            class="btn color-dark fs-4 align-self-end"
                                                            style="border-radius: 12px"><i
                                                                class="fal fa-cart-plus"></i></button>
                                                        <script>
                                                ...
                                                <div class="main-content text-center mb-3 py-auto">
                                                    ...
                                                    <h6 for="" class="mb-3 fs-3 color-3">
                                                        ...
                                                        <small class="text-muted"
                                                            style="font-size: 17px">{{ $product->price }}
                                                            TND</small>
                                                    ...
                                                    <form action="#" class="formsModal"
                                                        ...
                                                        <input type="hidden" value="{{ $product->product_id }}"
                                                            name="product_id">
                                                        <input type="hidden" value="{{ $resto->user_id }}"
                                                            name="resto_id">
                                                        <div class="border rounded p-3">
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a class=" fw-bold"
                                                                        id="incr{{ $product->product_id }}">
                                                                        <i class="fas fa-plus"></i>

                                                                    </a>
                                                                    <a class=" fw-bold"
                                                                        id="decr{{ $product->product_id }}">
