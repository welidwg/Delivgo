                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-6 info mx-auto">
                        ...
                        <script>
                            ...
                            if (moment(currentTime).isBetween(beforeTime, afterTime)) {

                                console.log('is between ' + beforeTime)
                                test = true
                        ...
                        <p>
                            ...
                            <?php if(date('H') < strtotime('6') && date('H') > strtotime('0')): ?>
                                <?php
                                    $frais = Config::latest();
                                ?>
                                <span class="fw-bold"><?php echo e($frais); ?> dt</span>
                            <?php else: ?>
                                <?php if($resto->deliveryPrice != 0 && $resto->deliveryPrice != null): ?>
                                    <span class="fw-bold"><?php echo e($resto->deliveryPrice); ?> dt</span>
                                <?php else: ?>
            ...
            <div class="container">
                ...
                <div class="row menu-container">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <span class="text-center fs-4 fw-bold mx-auto">Il n'ya pas encore des produits !</span>
                    <?php endif; ?>
