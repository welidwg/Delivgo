        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                    ...
                    <center class="m-t-30">
                        ...
                        <script>
                            $("#avatarForm").on("submit", (e) => {
                                ...
                                axios.post("/user/update/logo/{{ $user->user_id }}", formData)
                                    .then(res => {

                                        console.log(res)
                                        $("#submitAvatar").fadeOut()
                                        toastr.success(res.data.message)
                                        $('body').load("/dash/profile")
                ...
                <div class="card-body"> <small class="text-muted">Email address </small>
                    ...
                    <h6>+216 {{ $user->phone }}</h6> <small class="text-muted p-t-30 db">Address</small>
                    <h6>{{ $user->address != '' ? $user->address : 'unknown' }}</h6>
                    <div class="map-box">
                        <iframe
                ...
                <div class="card-body">
                    <form class="form-horizontal form-material mx-2" id="updateForm">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="name" placeholder="Johnathan Doe" value="{{ $user->name }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="password" name="password" placeholder="New Password (optional)" name="password"
                                    class="form-control form-control-line">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button type="submit" id="btnUpdate" class="btn btn-success text-white">Update
                                    Profile</button>
                            </div>
                        </div>
                    </form>
