                               ...
                               <?php $__empty_1 = true; $__currentLoopData = $cmds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cmd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                   <?php if(!$cmd->is_message): ?>
                                       ...
                                       <tr>
                                           ...
                                           <td id="dateLiv<?php echo e($cmd->id); ?>" class="d-none d-lg-table-cell">
                                           </td>
                                           <script>
                                               $('#datepass<?php echo e($cmd->id); ?>').html(moment("<?php echo e($cmd->created_at); ?>").format("LL | LT"))
                                               $('#dateLiv<?php echo e($cmd->id); ?>').html(moment("<?php echo e($cmd->updated_at); ?>").format("LL | LT"))
                                           </script>
                                           <td>
                                                           ...
                                                           <div
                                                               ...
                                                               <div class="col mb-2">
                                                                   <span>Date de livraison : <strong
                                                                           id="dateLivff<?php echo e($cmd->id); ?>">


                                                                       </strong></span>
                                                                   <script>
                                                                       $('#dateLivff<?php echo e($cmd->id); ?>').html(moment("<?php echo e($cmd->updated_at); ?>").format('LL | LT'))
                                                                   </script>
                                   ...
                                   <tbody>
                                       ...
                                       <?php $__empty_1 = true; $__currentLoopData = $commandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cmd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                           ...
                                           <tr>
                                               ...
                                               <td class="d-none d-lg-table-cell" id="dateLiv<?php echo e($cmd->id); ?>">
                                               </td>
                                               <script>
                                                   $('#datepass<?php echo e($cmd->id); ?>').html(moment("<?php echo e($cmd->created_at); ?>").format("LL | LT"))
                                                   $('#dateLiv<?php echo e($cmd->id); ?>').html(moment("<?php echo e($cmd->updated_at); ?>").format("LL | LT"))
                                                               ...
                                                               <div
                                                                   ...
                                                                   <div class="col mb-2">
                                                                       <span>Date de livraison :
                                                                           <strong id="dateLivr2<?php echo e($cmd->id); ?>">


                                                                           </strong>
                                                                       </span>
                                                                       <script>
                                                                           $('#dateLivr2<?php echo e($cmd->id); ?>').html(moment("<?php echo e($cmd->updated_at); ?>").format('LL | LT'))
                                                                       </script>
